    ...
    <div className="flex flex-col items-center max-w-xxl m-auto text-center">
            ...
            <tbody>
              {url_stats.map((url_stat, index) => (
                <tr key={index} className="hover">
                  <th>{index + 1}</th>
                  <td>
                    <a href={url_stat["url"]} target="_blank">
                      {url_stat["url"]}
                    </a>
                  </td>
                  <td>
      ...
      <label htmlFor="my-modal-4" className="modal cursor-pointer">
        <label className="modal-box relative" htmlFor="">
          ...
          <p className="py-4">
            Are you sure you want to delete the embeddings for{" "}
            <a href={deleteUrl} target="_blank">
              {deleteUrl}
            </a>{" "}
            ?
          </p>
          <label htmlFor="my-modal-4" className="btn btn-outline mr-5">
            Cancel
          </label>
          <label
            htmlFor="my-modal-4"
